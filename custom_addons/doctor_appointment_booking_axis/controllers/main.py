...
class WebsiteCalendar(http.Controller): 
    ...
    def appointment_country_choice(self, message=None, **kwargs):
        ...
        return request.render("doctor_appointment_booking_axis.appointment_country", value)
    ...
    def appointment_group_choice(self,state_id=None,  appointment_type=None,
        ...
        return request.render("doctor_appointment_booking_axis.appointment_1", value)
    ...
    def appointees_info(self, prev_emp=False, **post):
        ...
        return request.render("doctor_appointment_booking_axis.appointees_availability",value)
    ...
    def appointment_slots(self,appointment_type=None,timezone=None, prev_emp=False, **post):
        ...
        country_id = post.get('country_id')
        appointment_employee = request.env['hr.employee'].sudo().search([('id','=', post.get('id'))])
        appointment_type = request.env['calendar.appointment.type'].sudo().search([('partner_id','=',appointment_employee.work_contact_id.id)])
        _logger.info('appointment_type....%s ',appointment_employee.work_contact_id.id)
        value = {}
        if appointment_type:
            ...
            return request.render("doctor_appointment_booking_axis.slot", value)
        else:
            return request.render("doctor_appointment_booking_axis.slot_available")
    ...
    def appointment_form(self,appointment_type, **post):
        ...
        return request.render("doctor_appointment_booking_axis.appointment_form", {
    ...
    def calendar_appointment_submit(self, appointment_type, country_id=False, **kwargs):
        ...
        categ_id = request.env.ref('doctor_appointment_booking_axis.calendar_event_type_data_online_appointment')
        ...
        return request.render('doctor_appointment_booking_axis.appointment_confirm',value)
...
class CustomerPortal(CustomerPortal):
    ...
    def my_appointments(self, page=1, date_begin=None, date_end=None, sortby=None, search=None, search_in='content', **kw):
        ...
        return request.render("doctor_appointment_booking_axis.portal_appointment_layout",values)
    ...
    def appointments_followup(self, appointment_id=None, **kw):
        ...
        return request.render("doctor_appointment_booking_axis.appointments_followup",values)        
