...
class MobikulConfigSettings(models.TransientModel):
    ...
    mobikul_app = fields.Many2one('mobikul', string="Mobikul APP",
                                  default=_default_mobikul, required=True,store=False)
    ...
    mobikul_walk_through = fields.Boolean(
        string='Enable Walk Through',help="This allows users to guide about Mobikul App")
    mobikul_walk_through_version = fields.Char('Version')
    mobikul_guest_checkout = fields.Boolean(string="Allow Guest Checkout")
    ...
    module_website_sale_comparison = fields.Boolean(
        string='Allow Product Compare on App.', help="Use this feature to compare different products.")
    ...
    def get_values(self):
        ...
        res.update(
            ...
            mobikul_walk_through=safe_eval(IrConfigParam.get_param('mobikul.walk_through', 'False')),
            mobikul_walk_through_version=safe_eval(IrConfigParam.get_param('mobikul.walk_through_version', 'False')),
            mobikul_guest_checkout=safe_eval(IrConfigParam.get_param('mobikul.guest_checkout', 'False')),
    ...
    def set_values(self):
        ...
        IrConfigParam.set_param('mobikul.walk_through', repr(self.mobikul_walk_through))
        IrConfigParam.set_param('mobikul.walk_through_version', repr(self.mobikul_walk_through_version))
        IrConfigParam.set_param('mobikul.guest_checkout', repr(self.mobikul_guest_checkout))
