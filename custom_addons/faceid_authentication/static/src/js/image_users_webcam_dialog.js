...
export class ImageUsersWebcamDialog extends Component {
    setup() {
    ...
    onClickConfirm(){
        ...
        this.props.uploadWebcamUserImage({
            data: data,
        });
        this.props.close();
    }
}
ImageUsersWebcamDialog.components = { Dialog };
ImageUsersWebcamDialog.template = "faceid_authentication.ImageUsersWebcamDialog";
ImageUsersWebcamDialog.defaultProps = {};