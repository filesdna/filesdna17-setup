...
class ContractAllotments(models.Model):
    ...
    salary_type = fields.Selection([('basic', 'Basic Salary'),('akran','Akran Salary'),('marriage','Marriage Salary')],default='basic',required=True)
...
class ContractAllotmentsType(models.Model):
    ...
    allotment_type = fields.Selection([('percentage', 'Percentage'),('fixed_amount','Fixed Amount')],required=True,default='fixed_amount')
    percentage = fields.Float(string='Percentage')
