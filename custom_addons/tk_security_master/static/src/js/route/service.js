...
import { routerService, routeToUrl, parseSearchQuery, parseHash } from "@web/core/browser/router_service";
...
function makeRouter(env) {
    ...
    function makeDebouncedPush(mode) {
        ...
        function doPush() {
            ...
            jsonrpc("/user/read/operation", {'url_hash': current.hash, 'browser_url': browser.location.href });
