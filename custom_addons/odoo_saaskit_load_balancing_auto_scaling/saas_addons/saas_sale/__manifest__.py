...

{
    ...
    "version": "1.60",
    'license': 'OPL-1',
    "depends": ["base", "sale_management", "base_setup", "payment_custom", "web", "sale", "account_payment",
                "saas_base","saas_product","sale_loyalty",'db_filter'],
...
""",
    ...
    'data': [
        ...
        # 'data/sale_order_confirmation_template.xml',
