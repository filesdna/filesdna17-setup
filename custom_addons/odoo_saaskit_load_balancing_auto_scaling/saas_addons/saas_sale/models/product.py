...
#     saas_product_type= fields.Selection([('base','Base'), ('addon','Add Ons'), ('admin','Admin Use')], string='SaaS Product Type')
    ...
    industries = fields.Many2many('res.partner.industry', 'product_id', string="Industries")
    countries = fields.Many2many('res.country', 'product_countries', string="Countries")
    related_database = fields.Many2one("tenant.database.list",string="Related Database",domain=[('stage_id.is_active', '=', True)])
...
#                            string='Module List'),
    ...
    is_package = fields.Boolean(related='product_tmpl_id.is_package', string='is Package')
