...
class saas_config_setting(models.TransientModel):
    ...
    payment_acquire = fields.Many2one('payment.provider', string='Payment Method For trial Period', default=5,
                                      domain="[('module_state', '=', 'installed')]")
    tenant_conf_master_pwd = fields.Char(readonly=False, string="Tenant Conf Master Password",
                                  default_model="res.company",  config_parameter="tenant_conf_master_pwd",help="Tenant Server Master Password Specified in Conf File")
    # _defaults={
    #            'admin_pwd':'admin',
    #            'billing': 'normal',
    #            'admin_pwd':'admin',
    ...
    def set_favicon_logo(self, value):
        ...
        # _logger.info("paths >>>>>>>>>>>>>>>>{}".format(paths))
        # for item in paths:
        ...
        #     _logger.info("value>>>>>>>>>>>>{}".format(value))
    ...
    def get_values(self):
        ...
        res.update(
            ...
            payment_acquire=int(ICPSudo.get_param('payment_acquire', default=5)),
    ...
    def set_values(self):
        ...
        self.set_configs('bare_tenant_db', self.bare_tenant_db or 'bare_tenant_17')
