    ...
    def view_report(self, option, tag):
        ...
        move_line_ids = self.env['account.move.line'].search(
            [('account_type', 'in',
             ...
             ('parent_state', '=', 'posted')])
        # Below 2 lines added by Rigeesh
        partner_ids = move_line_ids.mapped('partner_id')
        partners = [{'id': partner.id, 'name': partner.name} for partner in partner_ids]
        ...
        #     Rigeesh added partners list
        return partner_dict, partners
