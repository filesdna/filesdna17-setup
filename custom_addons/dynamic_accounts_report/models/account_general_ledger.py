...
class AccountGeneralLedger(models.TransientModel):
    ...
    def view_report(self, option, tag):
        ...
        account_dict['analytic_ids'] = self.env[
            ...
            [], ['name'])
        accounts = [{'id':account.id,'name':account.name} for account in account_ids]
        ...
        return account_dict, accounts

    @api.model
    def get_filter_values(self,account_id, journal_id, date_range, options, analytic,
                          method):
        """
